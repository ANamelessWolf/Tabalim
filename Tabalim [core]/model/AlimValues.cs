...
namespace Tabalim.Core.model
{
    public class AlimValues
    {
        ...
        static IEnumerable<AlimValues> Data = new AlimValues[]
        {
            ...
            new AlimValues() { Calibre = "250KCM", Reactancia = 0.170603674540682, Resistencia = new Double[] { 0.177165354330709, 0.282152230971129 }, Impedancia = new Double[] { 0.232939632545932, 0.328083989501312 } },
            new AlimValues() { Calibre = "300KCM", Reactancia = 0.167322834645669, Resistencia = new Double[] { 0.147637795275591, 0.236220472440945 }, Impedancia = new Double[] { 0.206692913385827, 0.285433070866142 } },
            new AlimValues() { Calibre = "350KCM", Reactancia = 0.164041994750656, Resistencia = new Double[] { 0.127952755905512, 0.206692913385827 }, Impedancia = new Double[] { 0.187007874015748, 0.255905511811024 } },
            new AlimValues() { Calibre = "400KCM", Reactancia = 0.160761154855643, Resistencia = new Double[] { 0.114829396325459, 0.180446194225722 }, Impedancia = new Double[] { 0.173884514435696, 0.232939632545932 } },
            new AlimValues() { Calibre = "500KCM", Reactancia = 0.15748031496063, Resistencia = new Double[] { 0.0951443569553806, 0.147637795275591 }, Impedancia = new Double[] { 0.154199475065617, 0.200131233595801 } },
            new AlimValues() { Calibre = "600KCM", Reactancia = 0.15748031496063, Resistencia = new Double[] { 0.0820209973753281, 0.124671916010499 }, Impedancia = new Double[] { 0.141076115485564, 0.180446194225722 } },
            new AlimValues() { Calibre = "750KCM", Reactancia = 0.15748031496063, Resistencia = new Double[] { 0.0688976377952756, 0.101706036745407 }, Impedancia = new Double[] { 0.131233595800525, 0.160761154855643 } },
            new AlimValues() { Calibre = "1000KCM", Reactancia = 0.150918635170604, Resistencia = new Double[] { 0.0590551181102362, 0.0820209973753281 }, Impedancia = new Double[] { 0.118110236220472, 0.141076115485564 } }
        };
